...
class Index{
                            ...
                            <div class="row"> 
                                <div class="col-sm-6">
                                    <div class="card card-edit bg-color p-30">
                                        <h4><i class="fa fa-phone-alt"></i> Phone1</h4>';
                                    ...
                                    <div class="card pd-height bg-color p-30">
                                        ...
                                        <div class="contact-form form-style-one">
                                            <form action="#" id="contactUsForm" onsubmit="sendContactUs(event)">
                                                ...
                                                <div class="form-input mt-15">
                                                    <div class="input-items default">
                                                        <textarea name="note" placeholder="Massage"></textarea>
                                                        <i class="fas fa-massage fa-pen-to-square"></i>
                                                    </div>
                                                </div> 
                                                <div class="form-group col-md-12" style="margin-top:10px; padding-left:0px;">
                                                    <div id="mathCaptcha"></div>
                                                    <span id="errRecaptcha" style="color:red"></span>
                                                </div>
    ...
    private function headerHTML(){
        ...
        <head>
            ...
            <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7563816933258993"
